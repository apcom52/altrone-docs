...
export const SelectProperties: ComponentDescription = {
  ...
  properties: [
    ...
    },
    {
      ...
      version: 30,
      description:
        "Callback fires every time when one of the nested items is selected",
    },
    {
      name: "onChange",
      required: true,
    ...
    },
    {
      ...
      version: 30,
      description:
        "If true then the width of the popover cannot be less than width of the control",
    },
    {
      name: "Component",
    ...
    {
      name: "renderFunc",
      type: "CustomRenderFunction<SelectContext>",
      defaultValue: "undefined",
      version: 34,
      description: "Custom select render function",
    },
  ],
};
