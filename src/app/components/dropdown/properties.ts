  ...
  properties: [
    {
      ...
      version: 30,
      description: 'Interactive element that opens a dropdown. It can be button, link or any other interactive element. This element has to contain ref property'
    },
    {
      name: 'content',
      required: true,
    ...
    },
    {
      ...
      defaultValue: 'true',
      version: 30,
      description: 'When this prop is true then when user click on the action all popovers are closed'
    },
  ]
}
...
export const DropdownRadioListProperties: ComponentDescription = {
  ...
  properties: [
    ...
    },
    {
      ...
      defaultValue: 'undefined',
      version: 30,
      description: 'Callback fires when user changes the value of the radio list'
    },
    {
      name: 'children',
      required: true,
