import {Divider, Icon, Message, Flex} from "altrone-ui";
import {
...
import {TextCSSVariables} from "@/app/components/text/variables";
import {ConfigTable} from "@/components/PropertiesTable/ConfigTable";
import {HistoryItem} from "@/components/HistoryItem";

<BluePrint title="Text" description="This component is used to render text" group="Typography" version={30} />
...
<Flex gap="m" direction="vertical">
  <Message severity="primary" header="Best practices." onClose={() => {}}>
    {"If you want to render a big article, you need to wrap your content into &lt;Text&gt; component. Otherwise you can use subcomponents without <Text> wrapper."}
  </Message>
  <Message severity="danger" compact header="Upgrade your code." onClose={() => {}} icon={<Icon name="face" />}>
    {"In Altrone 3.4 the `role` prop for Text.Heading subcomponent is deprecated. Use `ariaRole` prop instead."}
  </Message>
</Flex>
...
<Text.Section gap='xl'>
  # CSS Variables
  <CSSVariablesList data={TextCSSVariables} />
</Text.Section>

<Text.Section gap="xl">
  # Configuration
  This component has some configuration settings. Use `<Configuration>` component to override component configuration.
  <ConfigTable filter="text." />
</Text.Section>

<Text.Section>
  # History
  <HistoryItem version="3.1">
    - added `variant` prop for Text.Heading subcomponent
    - added `ariaRole` prop for Text.Heading subcomponent
    - marked `role` prop as deprecated for Text.Heading subcomponent
  </HistoryItem>
